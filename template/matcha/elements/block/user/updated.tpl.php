<aside id="blockUserUpdated"  class="block collapsible">
<header><h3><?php echo gettext('block.user.updated.title')?></h3></header>
<div>
...
<a class="details" href="<?php echo $this->path ?>user/result/?sort=last_update"><?php echo gettext('block.extendedResult') ?></a>
</footer>
</div>
</aside>