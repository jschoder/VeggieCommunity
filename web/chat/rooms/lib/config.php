...
// Database hostname:
// $config['dbConnection']['host'] = 'mysql4.jschoder.de';
// Database username:
// $config['dbConnection']['user'] = 'db18632';
// Database password:
// $config['dbConnection']['pass'] = 'y322qckxuide';
// Database name:
// $config['dbConnection']['name'] = 'db18632';
...
$config['requestMessagesTimeDiff'] = 3;
